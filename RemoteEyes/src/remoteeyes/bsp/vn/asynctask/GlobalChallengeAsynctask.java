...
public class GlobalChallengeAsynctask extends AsyncTask<String, Void, String> {

	Activity activity;
	ProgressDialog progressDialog;

	public GlobalChallengeAsynctask(Activity activity) {
	...
	protected void onPostExecute(String result) {
		...
		try {
			...
			for (int i = 0; i < jarr.length(); i++) {
				...
				JSONArray jarrLocation = json.getJSONArray("locations");
	...
	protected String doInBackground(String... params) {
		...
		String url = String.format(Config.API_GLOBAL_CHALLENGE, params[0]);
