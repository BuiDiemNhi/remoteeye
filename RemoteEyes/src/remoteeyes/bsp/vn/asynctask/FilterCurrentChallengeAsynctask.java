...
public class FilterCurrentChallengeAsynctask extends
	...
	public FilterCurrentChallengeAsynctask(Context context) {
	...
	protected String doInBackground(String... params) {
		...
		arrNameValuePairs.add(new BasicNameValuePair("sort_field", params[8]));
