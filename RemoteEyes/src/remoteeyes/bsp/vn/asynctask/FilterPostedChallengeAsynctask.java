...
public class FilterPostedChallengeAsynctask extends
		AsyncTask<String, Void, String> {
	Context context;
	String isMine, isUpcoming, isIgnore, isHistory, isToday,isUnpaid, filter = "",
			userID;
	ArrayList<ChallengeObject> challengeList = new ArrayList<ChallengeObject>();
	ProgressDialog progressDialog;

	public FilterPostedChallengeAsynctask(Context context) {
	...
	protected String doInBackground(String... params) {
		...
		if(isUnpaid.equals("true")){filter+="filter_unpaid|";}
		...
		String json = jsonParser.makeHttpRequest(
				Config.GET_FILTER_POSTED_CHALLENGE, arrNameValuePairs);
		return json;
	}
