...
public class Panel extends LinearLayout {
	 ...
	 */
	public void setDrawable(Drawable openHandle, Drawable closeHande) {
		mHandle.setBackgroundDrawable(closeHande);
		mOpenedHandle = openHandle;
		mClosedHandle = closeHande;
	}
		...
		public void run() {
			...
			if (mOrientation == VERTICAL) {
				...
				if (mState == State.FLYING && mLinearFlying) {
					...
					Log.e("Test", "calculatedDuration: " + mDuration
